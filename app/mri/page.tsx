...
export default function MRIPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <AnalysisTips 
        content={{
          fast: "двухэтапный скрининг (сначала структурированное описание последовательностей, затем текстовый разбор), даёт компактный аналитический разбор и общий сигнал риска.",
