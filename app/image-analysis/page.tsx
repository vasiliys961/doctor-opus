    ...
    try {
      ...
      if (imageBase64) {
        ...
        if (cachedResult) {
          ...
          setLoading(false);
          setModelInfo({ 
            model: analysisMode === 'fast' ? 'google/gemini-3-flash-preview' : analysisMode === 'optimized' ? (optimizedModel === 'sonnet' ? 'anthropic/claude-sonnet-4.6' : 'openai/gpt-5.2') : 'anthropic/claude-opus-4.6',
