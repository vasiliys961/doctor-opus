    ...
    try {
      ...
      if (useStreaming && consultResponse.body) {
        ...
        await handleSSEStream(consultResponse, {
          ...
          onUsage: (usage) => {
            const model = usage.model || (modelType === 'gpt52' ? 'openai/gpt-5.6-terra' : 'anthropic/claude-opus-4.8');
            logUsage({
              section: 'genetic',
              model: model,
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <AnalysisTips 
        ...
        content={{
          ...
          extra: [
            ...
            "🚀 Альтернатива: «GPT-5.6 Terra» — отличный баланс скорости, мощности и стоимости.",
      ...
      <AnalysisResult 
        ...
        loading={loading} 
        model={lastModelUsed || (modelType === 'gpt52' ? 'openai/gpt-5.6-terra' : 'anthropic/claude-opus-4.8')}
        mode="genetic"
        cost={totalCost}
