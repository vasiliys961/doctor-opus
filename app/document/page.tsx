    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <AnalysisTips 
          ...
          content={{
            fast: scanMode === 'ai' ? "используется модель Gemini 3.0 Flash — она идеально подходит для быстрого и точного извлечения текста." : "локальный режим позволяет моментально создать качественный цифровой скан без отправки данных в сеть.",
            extra: scanMode === 'ai' ? [
