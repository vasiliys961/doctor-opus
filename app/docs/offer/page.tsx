  ...
  return (
    <LegalPageLayout title="Публичная оферта" lastUpdated="10.01.2026">
      <section className="prose prose-slate max-w-none text-sm sm:text-base">
        ...
        <p>
          3.2. Результаты работы ПО носят исключительно справочный и информационный характер, предназначены для поддержки принятия клинических решений специалистами и не являются медицинским заключением.
        </p>
        <p>
