    ...
    <LegalPageLayout title="Публичная оферта" lastUpdated="10.01.2026">
      <section className="prose prose-slate max-w-none text-sm sm:text-base">
        ...
        <div className="bg-teal-50 p-4 rounded-xl border border-teal-100 space-y-3">
          ...
          <p>
          4.3. <strong>Отмена подписки:</strong> Заказчик может в любой момент отключить автопродление в Личном кабинете (раздел «Подписка») либо путем обращения в поддержку по адресу vasily61@inbox.ru.
        </p>
          <p>
        ...
        <p>
          5.1. Стоимость и порядок оказания услуг устанавливаются на Сайте Исполнителя в разделе «Подписка». Все расчеты производятся в безналичном порядке через систему интернет-эквайринга <strong>Robokassa</strong>.
        </p>
        ...
        <div className="mt-10 p-6 bg-gray-50 rounded-2xl border border-gray-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-sm">
            ...
            <div className="space-y-1">
              ...
              <p><strong>Email:</strong> vasily61@inbox.ru</p>
