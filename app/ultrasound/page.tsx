      ...
      if (useStream && (analysisMode === 'validated' || analysisMode === 'optimized' || analysisMode === 'fast')) {
        ...
        if (data.success) {
          ...
          logUsage({
            ...
            model: modelUsed,
            inputTokens: 2000,
            outputTokens: Math.ceil(data.result.length / 4),
          })
        } else {
    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <AnalysisTips 
        content={{
          ...
          optimized: "рекомендуемый режим (Gemini JSON + Sonnet 4.5) — идеальный баланс точности и цены для УЗИ.",
          ...
          extra: [
            "✅ **GPT-5.2**: ЛУЧШИЙ выбор для 80% исследований (общая диагностика УЗИ).",
            "🦴 **Claude Sonnet 4.5**: ИСКЛЮЧЕНИЕ! ЛУЧШИЙ результат на деталях и мелких структурах.",
      ...
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4">Загрузите УЗИ изображение или DICOM файл</h2>
          ...
          <div className="mt-6 space-y-4">
            <div className="mb-4">
              ...
              <textarea
                ...
                placeholder="Пример: Пациентка 30 лет, боли в правом подреберье после приема пищи. Подозрение на ЖКБ."
