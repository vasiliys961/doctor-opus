...
const protocolFallback: ProtocolMessages = {
  ...
  conversationCostHint: 'Recording cost is {rate} credits per hour of audio and depends on conversation length. The timer shows the actual duration. Protocol generation is billed separately.',
...
export const protocolMessages: Record<Locale, ProtocolMessages> = {
  ...
  es: {
    ...
    conversationCostHint: 'El costo de la grabación es {rate} créditos por hora de audio y depende de la duración. El temporizador muestra la duración real. La generación del protocolo se cobra aparte.',
  ...
  fr: {
    ...
    conversationCostHint: 'Le coût de l’enregistrement est de {rate} crédits par heure d’audio et dépend de la durée. Le minuteur affiche la durée réelle. La génération du protocole est facturée à part.',
  ...
  ar: {
    ...
    conversationCostHint: 'تكلفة التسجيل {rate} رصيدًا لكل ساعة صوت وتعتمد على مدة المحادثة. المؤقت يعرض المدة الفعلية. إنشاء البروتوكول يُحسب بشكل منفصل.',
  ...
  hi: {
    ...
    conversationCostHint: 'रिकॉर्डिंग की लागत {rate} क्रेडिट प्रति घंटा ऑडियो है और अवधि पर निर्भर करती है। टाइमर वास्तविक अवधि दिखाता है। प्रोटोकॉल जनरेशन अलग से लगता है।',
  ...
  'pt-BR': {
    ...
    conversationCostHint: 'O custo da gravação é de {rate} créditos por hora de áudio e depende da duração. O cronômetro mostra a duração real. A geração do protocolo é cobrada à parte.',
  ...
  id: {
    ...
    conversationCostHint: 'Biaya rekaman {rate} kredit per jam audio dan bergantung pada durasi. Timer menampilkan durasi aktual. Pembuatan protokol ditagih terpisah.',
  ...
  ms: {
    ...
    conversationCostHint: 'Kos rakaman ialah {rate} kredit sejam audio dan bergantung pada tempoh. Pemasa menunjukkan tempoh sebenar. Penjanaan protokol dicaj berasingan.',
  ...
  tr: {
    ...
    conversationCostHint: 'Kayıt ücreti saatlik ses için {rate} kredidir ve süreye bağlıdır. Zamanlayıcı gerçek süreyi gösterir. Protokol üretimi ayrıca ücretlendirilir.',
  ...
  'zh-CN': {
    ...
    conversationCostHint: '录音费用为每小时音频 {rate} 积分，按实际时长计费。计时器显示实际时长。生成协议另行计费。',
