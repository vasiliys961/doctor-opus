...
export const SPECIALIST_CRITERIA = {
  ...
  xray: {
    ...
    requirements: '1. Идентифицируй анатомическую область (ОГК, череп, суставы, конечности, позвоночник, ОБП). 2. Для костных структур: оцени целостность кортикального слоя (поиск ступенчатых деформаций), структуру губчатого вещества, ширину и симметричность суставных щелей, контуры и соотношение эпифизов. 3. Для черепа: оцени свод и основание, турецкое седло, пневматизацию пазух. 4. Для ОГК: прозрачность легочных полей, корни, синусы, КТИ, купола диафрагмы. 5. Для ОБП: распределение газа, уровни жидкости.',
    pathologies: 'Переломы (линии просветления, прерывистость контура, смещение), вывихи, дегенеративные изменения (остеофиты, склероз, сужение щелей), инфильтрация, свободный газ/жидкость, снижение пневматизации пазух, объемные образования.',
  },
  ct: {
    title: 'КТ',
