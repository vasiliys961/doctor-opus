/**
 * Doctor Opus v3.42.0 — Централизованная конфигурация
 * 
...
export const BILLING_CONFIG = {
  ...
  guestTrialBalance: parseFloat(process.env.GUEST_TRIAL_BALANCE || '0'),
  ...
  initialBalance: parseFloat(process.env.INITIAL_BALANCE || '0'),
