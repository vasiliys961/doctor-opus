...
export const DEFAULT_TEMPLATES: ProtocolTemplate[] = [
  ...
  },
  {
    ...
    description: 'Клиническая часть протокола для врача-рентгенолога.',
    content: buildClinicalTemplate({
      complaintsHint: 'Жалобы по направлению на визуализацию',
      examFocus: 'Общее состояние: локальные симптомы: данные осмотра области интереса:',
      diagnosisHint: 'Диагноз по МКБ-10 с учетом визуализации',
      therapyHint: 'Фармакотерапия: МНН и 2 коммерческих (бренд и генерик), доступных в РФ'
    })
  },
  {
    ...
    name: '🔍 УЗИ',
    specialist: 'Врач УЗД',
    description: 'Клиническая часть протокола для врача УЗД.',
    content: buildClinicalTemplate({
      complaintsHint: 'Жалобы по направлению на УЗИ',
      examFocus: 'Общее состояние: локальные симптомы: данные осмотра области интереса:',
      diagnosisHint: 'Диагноз по МКБ-10 с учетом УЗИ',
      therapyHint: 'Фармакотерапия: МНН и 2 коммерческих (бренд и генерик), доступных в РФ'
    })
  },
  {
    ...
    description: 'Клиническая часть протокола для эндоскопии.',
    content: buildClinicalTemplate({
      complaintsHint: 'Жалобы по направлению на эндоскопию',
      examFocus: 'Общее состояние: живот: локальные симптомы: данные осмотра:',
      diagnosisHint: 'Диагноз по МКБ-10 с учетом эндоскопии',
      therapyHint: 'Фармакотерапия: МНН и 2 коммерческих (бренд и генерик), доступных в РФ'
    })
  },
  {
    ...
    description: 'Универсальный клинический протокол без лишних разделов.',
    content: buildClinicalTemplate({
