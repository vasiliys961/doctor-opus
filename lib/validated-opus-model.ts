...
function normalizeModelAlias(raw: string): string {
  ...
  if (value === '5.5' || value === 'opus-5.5' || value === 'claude-opus-5.5' || value === OPUS_55) {
    return OPUS_55;
  }
