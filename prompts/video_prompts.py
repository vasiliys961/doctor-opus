...
ВАЖНО: Указывай точные timestamps для всех патологических находок!""",
...
2. Рекомендации: динамика / КТ/МРТ / консультация специалиста
...
ЗАКЛЮЧЕНИЕ:
1. ЭХО-ПРИЗНАКИ: [Диагноз]
2. РЕКОМЕНДАЦИИ: динамика / МРТ / гистероскопия / онкомаркеры
...
Для КАЖДОГО образования:
- Локализация (доля, полушарие)
- Размер: X × Y × Z мм
- Сигнальные характеристики (T1, T2, FLAIR, DWI, T1+Gd)
- Форма, контуры
- Перифокальный отёк
- Масс-эффект
...
3. РЕКОМЕНДАЦИИ: МРТ с контрастом / МР-спектроскопия / биопсия / консультация
4. СРОЧНОСТЬ: плановое наблюдение / требует внимания / ЭКСТРЕННАЯ ситуация""",
...
ЗАКЛЮЧЕНИЕ:
1. КТ-КАРТИНА: [основной диагноз]
2. ДОПОЛНИТЕЛЬНЫЕ НАХОДКИ
3. СРАВНЕНИЕ С ПРЕДЫДУЩИМИ ИССЛЕДОВАНИЯМИ (если доступны)
4. РЕКОМЕНДАЦИИ: динамика / ПЭТ-КТ / биопсия / консультация
5. СРОЧНОСТЬ: плановое наблюдение / требует внимания / ЭКСТРЕННАЯ ситуация"""
}
...
def get_video_prompt(study_type: str) -> str:
    ...
    """
    return VIDEO_ANALYSIS_PROMPTS.get(study_type)
