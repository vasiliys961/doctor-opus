    ...
    <div className="container mx-auto px-4 py-8 max-w-7xl">
      ...
      <AnalysisTips 
        content={{
          ...
          precise: "более детальное, но сдержанное по объёму заключение без таблиц и «воды», когда нужно полноценно описать изменения и получить клинически полезный вывод.",
