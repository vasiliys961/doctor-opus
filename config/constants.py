...
# ============================================================================
# APP.PY КОНСТАНТЫ (Fallback значения)
# ============================================================================

# Fallback значения для app.py (если config модуль недоступен)
DEFAULT_PIL_MAX_IMAGE_PIXELS = 500000000  # Fallback для PIL_MAX_IMAGE_PIXELS
DEFAULT_IMAGE_MOBILE_MAX_SIZE = (1024, 1024)  # Fallback для IMAGE_MOBILE_MAX_SIZE
DEFAULT_IS_REPLIT = False  # Fallback для IS_REPLIT
DEFAULT_ALLOWED_IMAGE_EXTENSIONS = ['.jpg', '.jpeg', '.png']  # Fallback для ALLOWED_IMAGE_EXTENSIONS
...
# Токены
MAX_TOKENS_ECG = 3200  # Максимальное количество токенов для ЭКГ (слегка увеличено для более полного описания)
